...
<div
  class="absolute bottom-0 w-full h-[450px] flex flex-col bg-gradient-to-b from-background via-background to-accent/20 backdrop-blur-xl border-t border-white/10 shadow-2xl"
>
  <div
